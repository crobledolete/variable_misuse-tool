...
from tensorflow.keras.layers import InputSpec, LSTM
...
class PointerLSTM(keras.layers.Layer):
    ...
    def call(self, x, training=None, mask=None, states=None):
        ...
        #print('Repeating: ', input_shape[1])
        en_seq = x
        x_input = x[:, input_shape[1] - 1, :]
        x_input = K.repeat(x_input, 2)
        if states:
    ...
    def get_config(self):
        return {"hidden_dimensions": self.hidden_dimensions}
